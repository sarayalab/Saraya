        ...
        <View>
          <View style={styles.card}>
            ...
            <Text style={styles.paragraph}>
              Kelas ini mempelajari dan memahami konsep dasar ads/iklan untuk
              dapat menjadi pondasi penting dalam perkembangan usaha/UMKM. Bagi
              Kamu calon pengusaha sukses wajib memahami konsep dasar ads/iklan.
              Dengan pemahaman ads/iklan yang baik, Kamu dapat mempelajari
              pemasaran digital dengan lebih mudah.
            </Text>
          </View>
          <View style={styles.cardMateri}>
          <Text onPress={() => navigation.navigate("dasarIklan")}>
              Dasar Ads/iklan
            </Text>
            <View>
          ...
          <View style={styles.cardMateri}>
            <Text onPress={() => navigation.navigate("videoAds")}>
              Penjelasan Ads/iklan
            </Text>
            <View>
          ...
          <View style={styles.cardMateri}>
            <Text onPress={() => navigation.navigate("kuisAds")}>
              Kuis Ads/iklan
            </Text>
            <View>
