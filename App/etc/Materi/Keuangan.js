        ...
        />
          <View style={styles.card}>
            ...
            <Text style={styles.paragraph}>
              Kelas ini mempelajari dan memahami konsep dasar laporan keuangan untuk
              dapat menjadi pondasi penting dalam perkembangan usaha/UMKM. Bagi
              Kamu calon pengusaha sukses wajib memahami konsep dasar laporan keuangan.
              Dengan pemahaman laporan keuangan yang baik, Kamu dapat mempelajari
              pemasaran digital dengan lebih mudah.
            </Text>
          </View>
          <View style={styles.cardMateri}>
            <Text onPress={() => navigation.navigate("dasarKeuangan")}>
          ...
          <View style={styles.cardMateri}>
            <Text onPress={() => navigation.navigate("videoKeuangan")}>
          ...
          <View style={styles.cardMateri}>
            <Text onPress={() => navigation.navigate("kuisLaporanKeuangan")}>
              Kuis Laporan Keuangan
            </Text>
            <View>
